...
%stylusTip = [-17.1785587100098,-0.876455576069935,-158.083435085841];
...
for i = 1:5
    ...
    initTrans = randStartLocation-observedMean;
    
    %Apply this translation to xPts
    initialPts = (observedPts.' + initTrans.').';
    ...
    while rmsError > maxRMSError & iter < maxIterations & abs(rmsError - prevRMSE) > noImprovementFraction*prevRMSE
      ...
      xPts = (accumRot*(initialPts.') + accumTrans.').';
